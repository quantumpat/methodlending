            ...
            <div className="row align-items-center g-4">
              <div className="col-lg-6">
                ...
                <p className="lead text-muted">
                  Fast, transparent lending for acquisitions, rehab, and
                  bridge financing. We help you close confidently with clear
                  ...
                  <ul className="list-unstyled mb-4">
                    ...
                    <li className="d-flex align-items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted mb-0">
                          Real people, clear updates, and a partner in your
                          corner.
                        </p>
                      </div>
                    </li>
                  ...
                  <div className="col-md-6">
                    <div className="card h-100 border-0 shadow-sm">
                      <div className="card-body">
                        ...
                        <p className="text-muted mb-0">
                          Structured draw schedules and clear budgets for
                          renovation work.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col-md-6">
                    <div className="card h-100 border-0 shadow-sm">
                      <div className="card-body">
                        ...
                        <p className="text-muted mb-0">
                          Short-term flexibility to cover timing gaps or
                          refinance quickly.
                        </p>
                      </div>
                    </div>
          ...
          <div className="container">
            <div className="row align-items-center g-4">
              <div className="col-lg-6">
                ...
                <p className="text-muted">
                  A simple three-step workflow designed to keep your deal on
          ...
          <div className="container">
            <div className="row g-4 align-items-center">
              <div className="col-lg-6">
                ...
                <p className="text-muted">
                  Tell us about your next deal and we’ll follow up with a
                  tailored quote.
                </p>
